		...
		echo '
			...
			foreach ($category['boards'] as $board)
			{
				...
				echo '
					...
					if (!empty($board['children']))
					{
						...
						echo '
								...
								<p id="board_', $board['id'], '_children" class="children windowbg">
				...
				// Show some basic information about the number of posts, etc.
					...
					<td class="stats hidden-sm hidden-xs">
						<p>', comma_format($board['posts']), ' ', $board['is_redirect'] ? $txt['redirects'] : $txt['posts'], ' <br />
						', $board['is_redirect'] ? '' : comma_format($board['topics']) . ' ' . $txt['board_topics'], '
						</p>
					</td>
					<td class="lastpost hidden-sm hidden-xs">';
...
function template_info_center()
{
	...
	<div class="place_holder_div"><div class="innerframe">
		<div class="cat_bar">
			<h3 class="catbg">
	...
	if (!empty($settings['number_recent_posts']) && (!empty($context['latest_posts']) || !empty($context['latest_post'])))
	{
		echo '
			...
			<div class="hslice accordion-content ' , (!empty($settings['number_recent_posts']) && (!empty($context['latest_posts']) || !empty($context['latest_post']))) ? 'default' : '' , '" id="recent_posts_content">
		...
		elseif (!empty($context['latest_posts']))
		{
			...
			foreach ($context['latest_posts'] as $post)
				echo '
					...
					<dd class="hidden-sm hidden-xs">', $post['time'], '</dd>';
			echo '
				</dl>';
		}
		echo '
	...
	if ($settings['show_stats_index'])
	{
		echo '
			<div class="title-bar-center">
				<a class="accordion-control" href="">
					<img class="icon" src="', $settings['images_url'], '/icons/info.gif" alt="', $txt['forum_stats'], '" />
						', $txt['forum_stats'], '
				</a>
			</div>
			<div class="accordion-content ' , (!empty($settings['number_recent_posts']) && (!empty($context['latest_posts']) || !empty($context['latest_post']))) ? '' : 'default' , '">
				<p>
	...
	(function($) {
	  ...
	  var panels = $(\'.accordion > .accordion-content\').hide();
		$(\'.accordion > .default\').show();
	  $(\'.title-bar-center > .accordion-control\').click(function() {
		panels.slideUp();
