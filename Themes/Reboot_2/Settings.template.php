...
function template_settings()
{
	...
	'',
		array(
			'id' => 'primary_colour',
			'label' => $txt['primary_colour'],
			'description' => $txt['primary_colour_desc'],
			'type' => 'text',
			'size' => 8,
		),
		array(
			'id' => 'secondary_colour',
			'label' => $txt['secondary_colour'],
			'description' => $txt['secondary_colour_desc'],
			'type' => 'text',
			'size' => 8,
		),
		array(
			'id' => 'header_image',
			'label' => $txt['header_image'],
			'description' => $txt['header_image_desc'],
			'type' => 'text',
			'size' => 30,
		),
	);
